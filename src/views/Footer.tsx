      ...
      <div className="container mx-auto pt-20">
        <div className="flex flex-col justify-center items-center gap-2 mb-10">
          ...
          <div className="flex flex-col sm:flex-row gap-2 mb-2">
            ...
            <Button className="w-full sm:w-auto shadow-none border bg-white hover:bg-gray-100 text-customTextColor">
              Contact us
            </Button>
          </div>
        </div>
        <Separator />
        <div className="flex flex-col items-center p-5 sm:flex-row sm:items-center sm:justify-center">
          <span className="text-sm font-lato text-gray-500 sm:text-center dark:text-gray-400">
            © 2024 <Link to="https://restore-test.netlify.app/" className="hover:underline">ReStore™. </Link> All Rights Reserved.
          </span>
          {/* Uncomment to include social media links */}
           <div  className="flex mt-4 space-x-6 sm:justify-center sm:mt-0">
              <Link to="/" className="text-gray-500 hover:text-gray-900 dark:hover:text-white">
