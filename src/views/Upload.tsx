  ...
  return (
    ...
    >
      <Card className="max-w-sm w-full h-3/4 xl:shadow lg:shadow md:shadow sm:shadow xs:bg-transparent">
        <CardHeader className="px-10 flex justify-center items-center">
          <img src={restoreLogo} className="h-24 w-28 mr-3" />
           {/* Move logo here */}
        ...
        <CardContent className="px-10 flex flex-col items-center justify-center">
          ...
          <button
            ...
            className={`text-white py-2 px-4 rounded ${isUploading ? "opacity-50 cursor-not-allowed" : ""}`}
            style={{ backgroundColor: '#2CAA59' }}
          >
