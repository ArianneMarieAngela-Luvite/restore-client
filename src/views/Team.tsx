...
const Team = () => {
  return (
    ...
    <div id="team" className="h-3/4  w-full bg-white text-customTextColor">
        <div className="container mx-auto my-5 text-white">
            <motion.div 
                className="flex flex-col py-36 px-20 gap-14 text-customTextColo "
                animate={{ x: 0 }} 
                initial={{ opacity: 0 }}
                ...
                <div className="flex flex-row  w-full  gap-12 font-lato ">
                    <motion.div className="flex flex-col w-full shadow-lg items-center py-11 gap-6 bg-gray-100 text-black rounded-lg "
                    initial="hidden"
                    animate="visible"
                    >
                        <img src={idul} className="h-52 w-52 rounded-full shadow-lg"/>
                    ...
                    {/* <Separator /> */}
                    <div className="flex flex-col w-full  rounded-lg shadow-lg bg-gray-100 text-black items-center py-11 gap-6">
                        <img src={amara} className="h-52 w-52 rounded-full  shadow-lg"/>
                        <div className="flex flex-col items-center">
                    ...
                    {/* <Separator /> */}
                    <div className="flex flex-col w-full bg-gray-100 text-black items-center py-11 gap-6 shadow-lg rounded-lg">
                        <img src={hermi} className="h-52 w-52 rounded-full shadow-lg"/>
                        <div className="flex flex-col items-center">
