...
//     icon: "https://lottie.host/41a809aa-179c-471e-b5a1-ccee9a7aa2d1/eujOc2sHZ7.json",
...
//       icon: "https://lottie.host/your-lottie-file-url.json",
//   },
//   {
//     title: "Visual Trend Analysis",
//     description:
...
//   return (
//     <div id="about" className='isolate h-screen border  w-full  bg-white'>
//       <div  className="container mx-auto ">
//         <div className="py-16 mb-44 ">
...
//               {/* It is built for MSMEs, offering easy-to-use, AI-powered tools that transform how you predict sales, 
